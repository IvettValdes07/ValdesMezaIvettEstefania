...
Abre dashboard_mashup.html en tu navegador moderno (Chrome, Firefox, Edge)
...
Requerimientos cubiertos:
 Geolocalización — Mapa interactivo con coordenadas
 Redes Sociales — Extracción y visualización de perfiles
 E-Commerce — Catálogo con imagen y precio
 Bases de Datos — Registro de información en la nube
 Protocolos de Comunicación — Simulación de SMS/notificaciones
 Streaming — Reproductor de audio/video embebido con controles
 Dashboard unificado (Mashup) — Todas las APIs en una pantalla
 Archivos individuales por categoría
📄 Licencia
